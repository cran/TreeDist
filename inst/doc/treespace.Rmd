...
Tree space projection and analysis is made simple with the Shiny app included in
...
[outline of the basic functionality](https://ms609.github.io/TreeDist/reference/Project.html).
...
arising from this projection and be done:
...
```{r plot-projection-5d, fig.asp = 1, fig.align='center'}
